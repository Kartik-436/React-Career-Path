...
const Form = () => {
    ...
    return (
        <div className='z-[999] h-screen w-screen bg-transparent overflow-hidden'>
            <form ref={FormSignUp} id='SignUpForm' className='h-[85vh] w-[40vw] bg-white bg-opacity-7 absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 rounded-3xl backdrop-blur-sm border border-white border-opacity-10  p-[50px_40px] flex flex-col items-center justify-between'>

                <div className='flex flex-col gap-4'>
                    <h3 className='text-4xl text-center font-semibold'>Create an Account</h3>
                    <h2 className='text-lg text-center font-medium'>Create an account to continue</h2>
                </div>

                <div className='flex flex-col gap-2'>
                    <label className='flex' htmlFor="username">Email :</label>
                    <input className='h-[7vh] w-[32vw] rounded-lg px-4 py-4 bg-slate-100 cursor-text' type="text" placeholder="Email id" id="Email" />
                </div>
                ...
                <div className='flex flex-col items-center justify-center gap-3'>
                    ...
                    <p>Already have an account? <a className='cursor-pointer text-pretty text-[#B9FF66] font-bold text-xl' href='/logIn'>Login</a></p>
                </div>
