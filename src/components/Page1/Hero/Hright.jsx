...
const Hright = () => {
    ...
    useEffect(() => {
        ...
        timeline.from("#wrapper-p1-hright > *", {
            x: 500,
            duration: 1.2,
            ease: 'power2.inOut',
            opacity: 0,
        ...
        timeline.add(() => {
            ...
            // Megaphone animation sequence in timeline
    ...
    return (
        <div id='wrapper-p1-hright' className='w-[40%] h-[100%] relative'>
            ...
            <img
                id="Megaphone"
                className="absolute Breathe w-[55%] h-[60%] top-[42%] left-[43%] -translate-x-[50%] -translate-y-[50%]"
